...
| **Expert central (KPI)** | **101.40** | **100.50** | Округлённый fresh weekly bridge `101.41`; KPI tolerance `±0.5 п.п.` задаёт рабочий диапазон `100.90–101.90`. |
...
- fuel-upside `1.70` остаётся механической верхней оценкой с риском двойного учёта embedded fuel; он не используется как central point.
