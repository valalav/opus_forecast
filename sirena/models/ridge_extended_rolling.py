...
@ModelRegistry.register("ridge_extended_rolling_24m")
class RidgeExtendedRollingForecaster(RidgeExtendedForecaster):
    """RidgeExtended со скользящей сезонностью по последним N месяцам."""

    name = "ridge_extended_rolling_24m"
    OUTLIER_YEARS = [2010]
    BASE_FEATURES = [
        "y_lag1",
        "y_lag2",
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(alpha=alpha, use_macro=use_macro, **kwargs)
