"""
NGBoost + Shock Dummies
=======================

Эксперимент v4.6: NGBoost с shock dummy переменными из методик ЦБ.
"""
...
@ModelRegistry.register("ngboost_shock")
class NGBoostShockForecaster(BaseForecaster):
    ...
    def forecast(self, horizon: int = 12) -> np.ndarray:
        ...
        return np.array(
            [
                self.seasonal_norm.get(((last_month + i) % 12) + 1, 100.0) - 100
