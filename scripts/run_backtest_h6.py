"""
Backtest h=6: Прогноз на 6 месяцев вперед

Rolling window за последние 12 месяцев:
- Ноябрь 2025: train до мая → прогноз [июн...ноя] → берем ноябрь
- Октябрь 2025: train до апреля → прогноз [май...окт] → берем октябрь
- ... и так далее
...
if __name__ == '__main__':
    ...
    print(f"  - backtest_h6_predictions.csv")
    print(f"  - backtest_h6_metrics.csv")
    print(f"  - backtest_h6_summary.md\n")
