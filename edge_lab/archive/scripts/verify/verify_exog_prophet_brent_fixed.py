#!/usr/bin/env python3
"""
Verify ExogProphet Brent Regressor (Fixed Version)
=================================================
Tests that ExogProphet with Brent regressor achieves MAE <= 0.30
Uses fixed version with date alignment patch.
"""
...
def test_exog_prophet_mae():
    ...
    print("=" * 60)
    print("Testing ExogProphet with Brent Regressor (Fixed)")
    print("=" * 60)
    ...
    model_no_brent = ExogProphetBrentFixed(
        use_usd=True,
        use_brent=False,
        use_ki=True,
        yearly_seasonality=True,
