...
def main():
    ...
    df = calculate_ground_truth(weekly_df, anomaly_percentile=5.0)
    ...
    # Save results with EXACT column names required by acceptance criteria
    output_path = Path("data/anomaly_threshold_results.csv")
