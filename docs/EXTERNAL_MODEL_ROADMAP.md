...
Актуальная последовательность реализации после обновления источников и проверки Micro: [план от 09.09.2026 с разбором Opus](CPI_MODEL_DEVELOPMENT_PLAN.md). Этот каталог сохраняется как реестр идей; приоритеты, зависимости и условия ввода определены в новом плане.
