...
[Реализация P0–P2 и общий эксперимент](../archive/results/model_development/20260909_m1_02/REPORT.md).

[Обязательный контракт RAW/SA и контроль отсечек](DATA_FRESHNESS.md).

## Актуальный аудит модельного аппарата

[План развития моделей после разбора Opus, 09.09.2026](CPI_MODEL_DEVELOPMENT_PLAN.md) — предпосылки, P0–P7, источники, единая оценка, агрегация, модели и два уровня ввода.

[Обзор и план улучшений от 08.09.2026](../archive/results/analysis_notes/2026-09-08_model_apparatus_review.md) и [проверки перед повторной оценкой](MODEL_REVIEW_GATES.md).

[Приоритеты моделей после Micro, 09.09.2026](../archive/results/analysis_notes/2026-09-09_next_model_candidates.md) — общая динамика групп, недельные релизы, редкие изменения услуг и региональная панель.
